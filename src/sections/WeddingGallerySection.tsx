...
import { weddingProducts } from '@/data/products';
...
export function WeddingGallerySection() {
  ...
  return (
    <section
      id="wedding-gallery"
      ref={sectionRef}
      className="w-screen h-screen bg-blush relative overflow-hidden z-30"
    >
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        ...
        >
          <p className="text-label text-mauve mb-2">{t('wedding.gallery.label')}</p>
          <h2 className="font-serif text-section text-espresso">
            {t('wedding.gallery.title')}
          </h2>
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center px-[7vw]">
          ...
          >
            <ProductCard product={weddingProducts[0]} index={0} />
          </div>
          ...
          >
            <ProductCard product={weddingProducts[1]} index={1} />
          </div>
          ...
          >
            <ProductCard product={weddingProducts[2]} index={2} />
          </div>
        </div>
