...
export function EveningGallerySection() {
  ...
  return (
    <section
      id="evening-gallery"
      ref={sectionRef}
      className="w-screen h-screen bg-blush relative overflow-hidden z-50"
    >
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-[7vw]">
          ...
          >
            <ProductCard product={eveningProducts[0]} index={0} />
          </div>
          ...
          >
            <ProductCard product={eveningProducts[1]} index={1} />
          </div>
          ...
          >
            <ProductCard product={eveningProducts[2]} index={2} />
          </div>
        </div>
